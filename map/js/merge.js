...
var ZJData = [
    ...
    [{name: '杭州'}, {name: '厦门', value: 20}],
    [{name: '杭州'}, {name: '常州', value: 10}]
];

var SCData = [
    [{name: '成都'}, {name: '包头', value: 95}],
    [{name: '成都'}, {name: '昆明', value: 90}],
    [{name: '成都'}, {name: '郑州', value: 70}],
    [{name: '成都'}, {name: '重庆', value: 50}],
    [{name: '成都'}, {name: '拉萨', value: 50}],
    [{name: '成都'}, {name: '西宁', value: 80}],
    [{name: '成都'}, {name: '乌鲁木齐', value: 30}],
    [{name: '成都'}, {name: '北京', value: 30}],
    [{name: '成都'}, {name: '兰州', value: 100}],
    [{name: '成都'}, {name: '丹东', value: 20}]
];
...
var SDData = [
    ...
    [{name: '济南'}, {name: '大同', value: 70}],
    [{name: '济南'}, {name: '西安', value: 60}],
    [{name: '济南'}, {name: '成都', value: 50}],
    [{name: '济南'}, {name: '哈尔滨', value: 60}],
...
var XGData = [
    [{name: '香港'}, {name: '福州', value: 95}],
    [{name: '香港'}, {name: '太原', value: 90}],
    [{name: '香港'}, {name: '长春', value: 80}],
    [{name: '香港'}, {name: '大同', value: 70}],
    [{name: '香港'}, {name: '西安', value: 60}],
    [{name: '香港'}, {name: '成都', value: 50}],
    [{name: '香港'}, {name: '常州', value: 40}],
    [{name: '香港'}, {name: '北京', value: 30}],
    [{name: '香港'}, {name: '北海', value: 20}],
    [{name: '香港'}, {name: '海口', value: 10}]
];
...
var color = ['#a6c84c', '#ffa022', '#46bee9', '#fff', '#ffff00'];
var series = [];
[['杭州', ZJData], ['成都', SCData], ['武汉', HBData], ['济南', SDData], ['香港', XGData]].forEach(function (item, i) {
    series.push({
            name: item[0],
            type: 'lines',
            zlevel: 1,
